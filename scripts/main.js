...
// ★修正: 更新頻度を 2 (0.1秒) に変更してHUDのチラつきを防止
system.runInterval(() => {
    try {
        // 1. Player Loop
        world.getAllPlayers().forEach(player => {
            ...
            // バニラHPが減りすぎていたら回復（99999もあるので稀だが事故防止）
...
function applyStatsToEntity(player) {
    ...
    // ★修正: player.jsonイベントでのHP操作を削除し、ノックバックと速度のみ更新
